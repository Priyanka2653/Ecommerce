            ...
            <div className="flex flex-col h-screen p-3 bg-white  shadow w-96">
                <div className="space-y-3">
                    <div className="flex items-center">
                        <h2 className="text-xl font-bold text-4xl">Admin Panel</h2>
                    </div>
                    <div className="flex-1">
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            <li className="rounded-sm ">
                                <a
                                    href="#"
                                    className="flex items-center p-2 text-white space-x-3 rounded-md bg-slate-500 hover:bg-slate-500 hover:text-white">
                                    <svg
